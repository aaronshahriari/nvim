return function()
    ...
    checkbox = {
      ...
      custom = {
        ...
        ["local"] = {
          raw = '[l]',
          rendered = 'LOCAL',
          highlight = 'NeogitGraphBoldGray',
          scope_highlight = nil
        },
        develop = {
          raw = '[d]',
          rendered = 'DEV',
          highlight = 'NeogitGraphBoldYellow',
          scope_highlight = nil
        },
        qa = {
          raw = '[q]',
          rendered = 'QA',
          highlight = 'NeogitGraphBoldCyan',
          scope_highlight = nil
        },
        prod = {
          raw = '[p]',
          rendered = 'PROD',
          highlight = 'NeogitGraphBoldGreen',
          scope_highlight = nil
        },
      },
    },
  ...
  end, { desc = 'open md link under line in vsplit' })
end
