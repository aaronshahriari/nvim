return {
  ...
  --     },
  --     org_directories     = { '~/Dropbox/org/roam/' }, -- recurse for *.org
  --     exclude_files       = {},
  --     exclude_directories = {},
  --
  ...
  --       { name = 'PENDING',   keymap = 'op', color = '#FFAA00', strike_through = false, fields = { 'filename', 'todo', 'headline', 'priority', 'date', 'tags' } },
  --       { name = 'CANCELLED', keymap = 'ow', color = '#BD93F9', strike_through = true,  fields = { 'filename', 'todo', 'headline', 'priority', 'date', 'tags' } },
  ...
  --         name = '📅 Today',
  --         matcher = function(i)
  --           return i.scheduled and i.scheduled:is_today() and
  --               i.todo_state ~= 'DONE'
  --         end,
  ...
  --         name = '⭐ Important',
  --         matcher = function(i)
  --           return i.priority == 'A' and (i.deadline or i.scheduled) and
  --               i.todo_state ~= 'DONE'
  --         end,
  ...
  --         matcher = function(i)
  --           if i.todo_state ~= 'DONE' then return false end
  --           local d = i.scheduled or i.deadline
  --           if not d then return false end
  --
  --           local days = d:days_from_today()
  --           return days and days >= -6 and days <= 0
  --         end,
  --       }
  --     },
  --
